...
public class TopicController {
    ...
    @ResponseBody
    @IgnoreAuth
    public Response<PageInfo<TopicExecution>> selectBySectionId(@PathVariable String sectionId, @RequestParam(value = "page", defaultValue = "1") int page, @RequestParam(value = "pageSize", defaultValue = "15") int pageSize) {
    ...
    @ResponseBody
    @IgnoreAuth
    public Response<PageInfo<TopicExecution>> select(@RequestParam(value = "page", defaultValue = "1") int page, @RequestParam(value = "pageSize", defaultValue = "15") int pageSize) {
